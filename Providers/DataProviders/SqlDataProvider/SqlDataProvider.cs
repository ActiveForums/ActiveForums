...
#region Top Posts
		...
		public override IDataReader GetPosts(int PortalId, string Forums, bool TopicsOnly, bool RandomOrder, int Rows, int UserId, bool IgnoreSecurity, bool IsSuperUser, string Tags, int FilterByUserId = -1)
		{
			return (IDataReader)(SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "activeforums_TP_GetPosts", PortalId, Forums, TopicsOnly, RandomOrder, Rows, UserId, IgnoreSecurity, IsSuperUser, Tags, FilterByUserId));
		}
		//
