...
function maintRun(opt){
    ...
    if (opt == 1) {
        ...
        $.ajax({
				type: "POST",
				url: sf.getServiceRoot('ActiveForums') + "AdminService.ashx/RunMaintenance",
...
<div class="amcpcontrolstab" id="amcpcontrolstab">
	...
	<div id="divForum_afcontent" style="display:block;width:auto;min-height:400px;" class="amtabdisplay">
			  <table width="100%">
				<tr id="trGroups" runat="server">
					<td><img id="Img13" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:ForumGroup]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:ForumGroup]:</td>
					<td width="100%"><asp:dropdownlist id="drpGroups" runat="server" CssClass="amcptxtbx" /></td>
					<td style="width:50px;"><am:RequiredFieldValidator ID="reqGroups" runat="server" Text="*" ControlToValidate="drpGroups" DefaultValue="-1" ValidationGroup="afforum" /></td>
				</tr>
				<tr>
					<td><img id="Img14" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:ForumName]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap;"><asp:Label ID="lblForumGroupName" runat="server" Text="[RESX:ForumName]" />:</td>
					<td width="100%"><asp:textbox id="txtForumName" runat="server" Width="100%"  CssClass="amcptxtbx" MaxLength="255" /></td>
					<td><am:RequiredFieldValidator ID="reqForumName" runat="server" Text="*" ControlToValidate="txtForumName" ValidationGroup="afforum" /></td>
				</tr>
				<tr id="trDesc" runat="server">
					<td valign="top"><img id="Img15" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:ForumDesc]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" valign="top">[RESX:ForumDesc]:</td>
					<td width="100%"><asp:textbox id="txtForumDesc" runat="server" CssClass="amcptxtbx" TextMode="MultiLine" /></td>
					<td><img src="~/desktopmodules/activeforums/images/spacer.gif" width="20" runat="server" /></td>
				</tr>
				 <tr id="trPrefix" runat="server">
					<td valign="top"><img src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:VanityName]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" valign="top">[RESX:VanityName]:</td>
					<td width="100%"><asp:textbox id="txtPrefixURL" runat="server" Width="100%"  CssClass="amcptxtbx" MaxLength="50" onkeypress="return filterVanity(this,event);" /></td>
					<td><img src="~/desktopmodules/activeforums/images/spacer.gif" width="20" runat="server" /></td>
				</tr>
			</table>
			<table width="100%">
				<tr>
					<td><img id="Img20" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Active]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold">[RESX:Active]:</td>
					<td width="100%"><asp:CheckBox ID="chkActive" runat="server" Checked="true" /></td>
					<td></td>
				</tr>
				<tr>
					<td><img id="Img21" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Hidden]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold">[RESX:Hidden]:</td>
					<td><asp:CheckBox ID="chkHidden" runat="server" /></td>
					<td></td>
				</tr>
			</table>
			<table width="100%" id="trInherit" runat="server">
				<tr>
					<td><img id="Img9" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:InheritGroup]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap;">[RESX:InheritGroup]:</td>
					<td width="100%"><asp:CheckBox ID="chkInheritGroup" runat="server" /></td>
					<td></td>
				</tr>
			</table>
			<table width="100%" id="trTemplates" runat="server">
				<tr>
					<td colspan="4" class="amcpbold">[RESX:Templates]</td></tr>
				<tr>
					<td><img id="Img17" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:TopicsTemplate]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:TopicsTemplate]:</td>
					<td width="100%"><asp:DropDownList ID="drpTopicsTemplate" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
				<tr>
					<td><img id="Img18" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:TopicTemplate]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:TopicTemplate]:</td>
					<td width="100%"><asp:DropDownList ID="drpTopicTemplate" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
				<tr>
					<td><img id="Img22" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:TopicForm]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:TopicForm]:</td>
					<td width="100%"><asp:DropDownList ID="drpTopicForm" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
				<tr>
					<td><img id="Img23" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:ReplyForm]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:ReplyForm]:</td>
					<td width="100%"><asp:DropDownList ID="drpReplyForm" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
			   <%-- <tr>
				...
				<tr>
					<td><img id="Img16" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:UserProfileTemplate]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:UserProfileTemplate]:</td>
					<td width="100%"><asp:DropDownList ID="drpProfileDisplay" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
				<tr>
					<td><img id="Img19" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:EmailAddress]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:EmailAddress]:</td>
					<td width="100%"><asp:TextBox ID="txtEmailAddress" runat="server" CssClass="amcptxtbx" /></td>
					<td></td>
				</tr>
	...
	<div id="divSettings_afcontent" style="display:none;" class="amtabdisplay">
			...
			<table>
				...
				<tr>
					<td><img id="Img25" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Moderated]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:Moderated]</td>
					<td align="center"><asp:RadioButton ID="rdModOn" GroupName="Moderated" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdModOff" GroupName="Moderated" runat="server" Checked="true" /></td>
					<td width="100%"><div id="cfgMod" runat="server" class="amcfgbtn" style="display:none;"></div></td>
				</tr>
				<tr>
					<td><img id="Img1" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Filters]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:EnableFilter]:</td>
					<td align="center"><asp:RadioButton ID="rdFilterOn" GroupName="Filter" runat="server" Checked="true" /></td>
					<td align="center"><asp:RadioButton ID="rdFilterOff" GroupName="Filter" runat="server" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img2" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:PostIcon]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:AllowPostIcon]:</td>
					<td align="center"><asp:RadioButton ID="rdPostIconOn" GroupName="PostIcon" runat="server" Checked="true" /></td>
					<td align="center"><asp:RadioButton ID="rdPostIconOff" GroupName="PostIcon" runat="server" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img3" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Emoticons]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:Emoticons]:</td>
					<td align="center"><asp:RadioButton ID="rdEmotOn" GroupName="Emot" runat="server" Checked="true" /></td>
					<td align="center"><asp:RadioButton ID="rdEmotOff" GroupName="Emot" runat="server" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img4" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Scripts]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:AllowScripts]:</td>
					<td align="center"><asp:RadioButton ID="rdScriptsOn" GroupName="Scripts" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdScriptsOff" GroupName="Scripts" runat="server" Checked="true" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img5" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:IndexContent]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:IndexContent]:</td>
					<td align="center"><asp:RadioButton ID="rdIndexOn" GroupName="Index" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdIndexOff" GroupName="Index" runat="server" Checked="true" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img6" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:RSS]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:AllowRSS]:</td>
					<td align="center"><asp:RadioButton ID="rdRSSOn" GroupName="RSS" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdRSSOff" GroupName="RSS" runat="server" Checked="true" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img7" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:Attachments]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:AllowAttach]:</td>
					<td align="center"><asp:RadioButton ID="rdAttachOn" GroupName="Attach" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdAttachOff" GroupName="Attach" runat="server" Checked="true" /></td>
					<td width="100%"></td>
				</tr>
				<tr>
					<td><img id="Img8" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:AllowHTML]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap">[RESX:AllowHTML]:</td>
					<td align="center"><asp:RadioButton ID="rdHTMLOn" GroupName="HTML" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdHTMLOff" GroupName="HTML" runat="server" Checked="true" /></td>
					<td width="100%"><div id="cfgHTML" runat="server" class="amcfgbtn" style="display:none;"></div></td>
				</tr>
...
<%--                <tr>
				...
				<tr id="trAutoSub" runat="server" visible="false">
					<td><img id="Img26" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:AutoSubscribe]');" onmouseout="amHideTip(this);" /></td>
					<td class="amcpbold" style="white-space:nowrap;">[RESX:AutoSubscribe]:</td>
					<td align="center"><asp:RadioButton ID="rdAutoSubOn" GroupName="AutoSubscribe" runat="server" /></td>
					<td align="center"><asp:RadioButton ID="rdAutoSubOff" GroupName="AutoSubscribe" runat="server" Checked="true" /></td>
					<td width="100%"><div id="cfgAutoSub" runat="server" class="amcfgbtn" style="display:none;"></div></td>
				</tr>
			</table>
	   </div>
	   </div>
...
<div id="divClean_afcontent" style="display:none;" class="amtabdisplay">
	<div style="width:500px;margin-left:auto;margin-right:auto;padding-top:5px;">
		<table>
			...
			<tr>
				<td class="amcpbold"><asp:label ID="lblMaintWarn" runat="server" Text="[RESX:MaintenanceWarning]" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div style="width:350px;margin-left:auto;margin-right:auto;padding-top:5px;">
					<table>
						<tr>
						<td><img id="Img45" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:MaintOlderThan]');" onmouseout="amHideTip(this);" /></td>
							<td><asp:CheckBox ID="chkTopicsOlderThan" runat="server" /></td><td>[RESX:Maint:TopicsOlderThan]</td>
							<td><asp:TextBox ID="txtOlderThan" runat="server" class="amcptxtbx" Width="40" />([RESX:Maint:Days])</td>

						</tr>
						<tr>
						<td><img id="Img46" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:MaintTopicsByUser]');" onmouseout="amHideTip(this);" /></td>
							<td><asp:CheckBox ID="chkTopicsByUser" runat="server" /></td><td>[RESX:Maint:TopicsByUser]</td>
							<td><asp:TextBox ID="txtUserId" runat="server" class="amcptxtbx" Width="40" /></td>

						</tr>
						<tr>
						<td><img id="Img47" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:MaintWithOutReplies]');" onmouseout="amHideTip(this);" /></td>
							<td><asp:CheckBox ID="chkNoReplies" runat="server" /></td><td>[RESX:Maint:WithoutReplies]</td>
							<td></td>
						</tr>
						<tr>
						<td><img id="Img48" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:MaintActivityOlderThan]');" onmouseout="amHideTip(this);" /></td>
							<td><asp:CheckBox ID="chkActivityOlderThan" runat="server" /></td><td>[RESX:Maint:NoActivityPast]</td>
							<td><asp:TextBox ID="txtReplyOlderThan" runat="server" class="amcptxtbx" Width="40" />([RESX:Maint:Days])</td>
						...
						<tr>
							<td colspan="3" align="center">
								<table>
									<tr>
										<td> <am:ImageButton ID="imgTestRun" runat="server" PostBack="false" ClientSideScript="maintRun(1);" CssClass="amsmallbtn" Text="[RESX:Maint:TestRun]" Height="18" Width="85" ImageLocation="LEFT" ImageUrl="~/DesktopModules/ActiveForums/images/testrun16.png" /></td>
										<td><am:ImageButton ID="imgExecute" runat="server" PostBack="false" ClientSideScript="maintRun(0);" CssClass="amsmallbtn" Text="[RESX:Maint:Execute]" Height="18" Width="85" ImageLocation="LEFT" ImageUrl="~/DesktopModules/ActiveForums/images/execute16.png" /></td>
									</tr>
							   </table>
...
<div id="divProperties_afcontent" style="display:none;" class="amtabdisplay">
 <div class="amcphd">[RESX:TopicProperties]</div>
	...
	<ul id="proplist" style="display:none;">
		<li class="afclear prophead"><div style="float:left;">[RESX:Properties]</div><div style="width:150px;float:right;">[RESX:Visibility]</div></li>
...
<div class="ammodalpop" style="display:none;position:absolute;height:150px;margin:0px;width:255px;" id="edProp">
	...
	<tr>
		...
		<td><asp:DropDownList ID="drpPermittedRoles" runat="server" CssClass="amcptxtbx">
	...
	<tr>
		...
		<td width="100%"><asp:DropDownList ID="drpEditorTypes" runat="server" CssClass="amcptxtbx">
	...
	<tr>
		...
		<td width="100%"><asp:TextBox ID="txtEditorHeight" runat="server" CssClass="amcptxtbx" Text="400" /></td>
		<td></td>
	</tr>
	<tr>
		<td></td>
		<td class="amcpbold">[RESX:EditorWidth]:</td>
		<td width="100%"><asp:TextBox ID="txtEditorWidth" runat="server" CssClass="amcptxtbx" Text="99%" /></td>
		<td></td>
	</tr>
	<tr>
		<td></td>
		<td class="amcpbold">[RESX:EditorToolBar]:</td>
		<td width="100%"><asp:TextBox ID="txtEditorToolBar" runat="server" CssClass="amcptxtbx" Text="bold,italic,underline" /></td>
		<td></td>
	</tr>
	<tr>
		<td></td>
		<td class="amcpbold">[RESX:EditorStyle]:</td>
		<td width="100%"><asp:DropDownList ID="drpEditorStyle" runat="server" CssClass="amcptxtbx">
...
<div style="margin:0px;padding:10px;">
	...
	<table cellpadding="0" cellspacing="2" border="0" style="margin:0px;padding:0px;">
		<tr>
			...
			<td width="100%"><asp:DropDownList ID="drpDefaultTrust" runat="server"><asp:ListItem Value="0" Text="[RESX:NotTrusted]" /><asp:ListItem Value="1" Text="[RESX:Trusted]" /></asp:DropDownList></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td class="amcpbold" style="white-space:nowrap">[RESX:AutoTrustLevel]:</td>
			<td width="100%"><asp:TextBox ID="txtAutoTrustLevel" runat="server" Width="50px" CssClass="amcptxtbx" Text="0" /></td>
			<td></td>
		</tr>
	 </table>
	 <table cellpadding="0" cellspacing="2" border="0" style="margin:0px;padding:0px;">
		...
		<tr>
			...
			<td width="100%"><asp:DropDownList ID="drpModNotifyTemplateId" runat="server" CssClass="amcptxtbx" /></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td class="amcpbold">[RESX:Approved]:</td>
			<td width="100%"><asp:DropDownList ID="drpModApprovedTemplateId" runat="server" CssClass="amcptxtbx" /></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td class="amcpbold">[RESX:Rejected]:</td>
			<td width="100%"><asp:DropDownList ID="drpModRejectTemplateId" runat="server" CssClass="amcptxtbx" /></td>
			<td></td>
		</tr>
		 <tr>
			<td></td>
			<td class="amcpbold">[RESX:Moved]:</td>
			<td width="100%"><asp:DropDownList ID="drpModMoveTemplateId" runat="server" CssClass="amcptxtbx" /></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td class="amcpbold">[RESX:Deleted]:</td>
			<td width="100%"><asp:DropDownList ID="drpModDeleteTemplateId" runat="server" CssClass="amcptxtbx" /></td>
			<td></td>
		</tr>
...
<div class="ammodalpop" style="display:none;position:absolute;height:135px;width:240px;margin:0px;" id="subProp">
	...
	<tr>
		...
		<td width="100%"><asp:DropDownList ID="drpRoles" runat="server" CssClass="amcptxtbx" /></td>
...
<div class="ammodalpop" style="display:none;position:absolute;height:135px;width:240px;margin:0px;" id="socialProp">
	...
	<tr>
		...
		<td width="100%"><asp:DropDownList ID="drpSocialSecurityOption" runat="server" CssClass="amcptxtbx">
...
<div class="amcp-mod-inner" style="height:348px;">
	...
	<div class="afclear"></div>
		...
		<table class="amcpformlist afclear ampropeditor" id="ampropform">
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:PropertyName]:</label></td>
				<td><input type="text" id="txtPropertyName" title="[RESX:PropertyName]" required="true" value="" onkeyup="updateShadow(this,event,'txtLabel');" onkeypress="return filterInput(this,event,'txtLabel');" style="width:225px;" /></td>
			</tr>
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:Label]:</label></td><td><input type="text" id="txtLabel" title="[RESX:Label]" required="true" value="" style="width:225px;" /></td>
			</tr>
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:DataType]:</label></td>
				<td><select id="drpDataType" onchange="afadmin_propDataTypeChange();" style="width:225px;"><option value="text">[RESX:Text]</option>
			 ...
			 <tr style="display:none;">
				<td style="text-align:right;width:150px;"><label>[RESX:ListName]:</label></td><td><select id="drpLists" style="width:225px;"></select></td>
			</tr>
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:IsHidden]:</label></td>
				<td><div class="amcpradiorow"><span>[RESX:No]</span><input type="radio" name="prophidden" isdefault="true" value="false" id="propHiddenNo" checked="checked" /><span>[RESX:Yes]</span><input type="radio" name="prophidden" value="true" id="propHiddenYes" /></div></td>
			</tr>
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:IsRequired]:</label></td>
				<td><div class="amcpradiorow"><span>[RESX:No]</span><input type="radio" name="propreq" isdefault="true" value="false" id="propReqNo" checked="checked" /><span>[RESX:Yes]</span><input type="radio" name="propreq" value="true" id="propReqYes" /></div></td>
			</tr>
			<tr>
				<td style="text-align:right;width:150px;"><label>[RESX:ValidationExpression]:</label></td>
				<td><input type="text" id="txtValExp" value="" style="width:225px;" /></td>
			</tr>
			<tr style="display:none;">
				<td style="text-align:right;width:150px;"><label>[RESX:DefaultValue]:</label></td>
				<td><input type="text" id="txtDefaultValue" value="" /></td>
			</tr>
			<tr style="display:none;">
				<td style="text-align:right;width:150px;"><label>[RESX:EditTemplate]:</label></td>
				<td><input type="text" id="txtEditTemplate" value="" /></td>
			</tr>
			<tr style="display:none;">
				<td style="text-align:right;width:150px;"><label>[RESX:ViewTemplate]:</label></td>
				<td><input type="text" id="txtViewTemplate" value="" /></td>
			</tr>
			<tr style="display:none;">
				<td style="text-align:right;width:150px;"><label>[RESX:IsReadOnly]:</label></td>
				<td><div class="amcpradiorow"><span>[RESX:No]</span><input type="radio" name="propreadonly" isdefault="true" value="false" id="propReadOnlyNo" checked="checked" /><span>[RESX:Yes]</span><input type="radio" name="propreadonly" value="true" id="propReadOnlyYes" /></div></td>
			</tr>
		</table>
