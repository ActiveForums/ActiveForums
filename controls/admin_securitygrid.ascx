...
function securityCallback(action, returnId, pid, secId,secName, secType, key, callback) {
			...
			$.ajax({
				type: "POST",
				url: sf.getServiceRoot('ActiveForums') + "AdminService.ashx/ToggleSecurity",
					...
					<tr>
					   <td class="amroles">
							<table cellpadding="0" cellspacing="2">
								<tr>
									<td style="width:12px;"><img id="Img43" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:AddRoles]');" onmouseout="amHideTip(this);" /></td>
									<td>[RESX:Roles]:</td>
									<td style="width:150px;"><asp:Literal ID="litRoles" runat="server" /></td>
									<td style="width:16px;"><div class="amcpimgbtn" style="width:16px;" onclick="addObject(0);"><img id="Img41" src="~/desktopmodules/activeforums/images/add.png" runat="server" alt="[RESX:AddRole]" /></div></td>
								 </tr>
							</table>
						</td>
						<td style="width:5%"></td>
						...
						<table cellpadding="0" cellspacing="2">
								<tr>
								<td style="width:12px;"><img id="Img44" src="~/DesktopModules/ActiveForums/images/tooltip.png" runat="server" onmouseover="amShowTip(this, '[RESX:Tips:AddUser]');" onmouseout="amHideTip(this);" /></td>
									<td>[RESX:UserName]:</td><td style="width:150px;"><asp:TextBox ID="txtUserName" runat="server" CssClass="amcptxtbx" Width="150" /></td>
									<td style="width:16px;"><div class="amcplnkbtn" style="width:16px;" onclick="addObject(1);"><img id="Img42" src="~/desktopmodules/activeforums/images/add.png" runat="server" alt="[RESX:AddUserName]" /></div></td>
								</tr>
							</table>
							</div>
