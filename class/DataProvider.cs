...
#region Top Posts
		...
		public abstract IDataReader GetPosts(int PortalId, string Forums, bool TopicsOnly, bool RandomOrder, int Rows, int UserId, bool IgnoreSecurity, bool IsSuperUser, string Tags, int FilterByUserId = -1);
